...
# 4. 프로젝트 소스 복사 (app 폴더 내부만)
COPY app .

# 5. 모델 weight 폴더 생성
RUN mkdir -p model_weight

# 6. pt파일 다운로드 (이제 model_weight/ 하위에 저장!)
RUN wget -O model_weight/EfficientNet_B3_BIDDEM_V3.1_2025_05_24_19_model.pt \
    "https://github.com/AnJungMin/AIOpsBackend/releases/download/v1.0/EfficientNet_B3_BIDDEM_V3.1_2025_05_24_19_model.pt"
RUN wget -O model_weight/EfficientNet_B3_MISE_V4_2025_05_26_18_model.pt \
    "https://github.com/AnJungMin/AIOpsBackend/releases/download/v1.0/EfficientNet_B3_MISE_V4_2025_05_26_18_model.pt"
RUN wget -O model_weight/EfficientNet_B3_MONO_V4_2025_05_27_16_model.pt \
    "https://github.com/AnJungMin/AIOpsBackend/releases/download/v1.0/EfficientNet_B3_MONO_V4_2025_05_27_16_model.pt"
RUN wget -O model_weight/EfficientNet_B3_MOSA_V5_TUNNING_2025_06_01_23_final_model.pt \
...
RUN wget -O model_weight/EfficientNet_B3_PIZI_V4_2025_05_27_17_model.pt \
    "https://github.com/AnJungMin/AIOpsBackend/releases/download/v1.0/EfficientNet_B3_PIZI_V4_2025_05_27_17_model.pt"
RUN wget -O model_weight/EfficientNet_B3_TALMO_V5_TUNNING_2025_06_01_16_model.pt \
